...
<div class="box">
    ...
    <div class="color mb-20">
        <img src="zdjecia/jager.png" alt="napraw kod" class="quantity" style="height: 50px">
        <div class="alcohol fb text-uppercase alcohol alcohol-statistics">Statystyki jagera</div>
        <div class="clearfix"></div>
        <div class="font-weight"></div>
        <div class="" style="font-size: 13px">
            <div class="left-column">
                <div class="mb-5">Suma wypitego jagera:</div>
            ...
            <div class="right-column">
                <?php
                echo '<div class="mb-5">' . $sumaJagera . '</div>' .
